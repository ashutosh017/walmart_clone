...
function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row bg-walmart px-10 items-center space-x-5 py-7">
      ...
      >
        ...
        />
        <button type="submit">
          <Search className=" rounded-full h-10 bg-yellow-400 px-2 w-10 cursor-pointer " />
        </button>
      </form>
      <div className="flex space-x-5 mt-5 md:mt-0 ">
        ...
        <Link
          href={"/"}
          className="flex text-white items-center font-bold space-x-2 text-sm"
        >
          <Heart size={20} />
          <div>
